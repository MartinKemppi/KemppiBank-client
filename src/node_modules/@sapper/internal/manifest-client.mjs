...
export const ignore = [/^\/auth\/register\/?$/, /^\/auth\/logout\/?$/, /^\/auth\/login\/?$/, /^\/blog\.json$/, /^\/blog\/([^/]+?)\.json$/];
...
if (typeof window !== 'undefined') {
	import("C:/Users/Matti/source/repos/KemppiBank-client/node_modules/sapper/sapper-dev-client.js").then(client => {
