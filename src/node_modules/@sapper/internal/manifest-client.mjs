...
export const ignore = [/^\/auth\/getTransactions\/?$/, /^\/auth\/getMyData\/?$/, /^\/auth\/register\/?$/, /^\/auth\/logout\/?$/, /^\/auth\/login\/?$/, /^\/blog\.json$/, /^\/blog\/([^/]+?)\.json$/];
...
export const components = [
	...
	{
		js: () => import("../../../routes/overview.svelte")
	},
	{
		js: () => import("../../../routes/register.svelte")
	},
	{
		js: () => import("../../../routes/about.svelte")
	},
	{
		js: () => import("../../../routes/login.svelte")
	},
	{
...
if (typeof window !== 'undefined') {
	import("C:/Users/opilane/source/repos/KemppiBank-client/node_modules/sapper/sapper-dev-client.js").then(client => {
